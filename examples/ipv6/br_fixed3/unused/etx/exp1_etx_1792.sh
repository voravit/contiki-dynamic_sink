...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.etx.1792 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	java -mx1792m -jar ${BASE_COOJA}/dist/cooja.jar -nogui=$FILE
	...
	sleep 2
	mkdir etx_1792_${RATE}
	mv COOJA* log*txt etx_1792_${RATE}
	mv *pcap etx_1792_${RATE}
	mv tun*txt etx_1792_${RATE}
	mv nohup.out etx_1792_${RATE}
	mv route.out etx_1792_${RATE}
	mv etx_1792_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE etx_1792_${RATE}/.
	mv udp.out etx_1792_${RATE}/.
	mv coordinator.out etx_1792_${RATE}/.
