...
CTR=0
	...
	sed -i "s/<success_ratio_rx>1\.0/<success_ratio_rx>0\.6/" run.csc
	...
	#sed -i "2156s/<bound>false/<bound>true/" run.csc
        ...
        sed -i "s/SINK_ADDITION 1/SINK_ADDITION 2/" project-conf.h
...
#	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.uc.rxh /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        sed -i "s/ARR_RXH_TH 50/ARR_RXH_TH ${VALUE}/" /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	sed -i "s/ARR_RXH_TH_DEACT 15/ARR_RXH_TH_DEACT 20/" /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir uc_nbr_${VALUE}_${RATE}
	mv COOJA* log*txt uc_nbr_${VALUE}_${RATE}
	mv *pcap uc_nbr_${VALUE}_${RATE}
	mv tun*txt uc_nbr_${VALUE}_${RATE}
	mv nohup.out uc_nbr_${VALUE}_${RATE}
	mv route.out uc_nbr_${VALUE}_${RATE}
	mv uc_nbr_${VALUE}_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE uc_nbr_${VALUE}_${RATE}/.
	mv udp.out uc_nbr_${VALUE}_${RATE}/.
	mv coordinator.out uc_nbr_${VALUE}_${RATE}/.
