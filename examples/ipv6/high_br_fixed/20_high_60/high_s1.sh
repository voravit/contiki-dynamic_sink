...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir s_1_${RATE}
	mv COOJA* log*txt s_1_${RATE}
	mv *pcap s_1_${RATE}
	mv tun*txt s_1_${RATE}
	mv nohup.out s_1_${RATE}
	mv route.out s_1_${RATE}
	mv s_1_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE s_1_${RATE}/.
	mv udp.out s_1_${RATE}/.
	mv coordinator.out s_1_${RATE}/.
