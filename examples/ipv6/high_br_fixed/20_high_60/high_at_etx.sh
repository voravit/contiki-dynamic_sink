...
#	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.at.etx /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        sed -i "s/ARR_ETX_TH 128/ARR_ETX_TH ${VALUE}/" /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir at_etx_${VALUE}_${RATE}
	mv COOJA* log*txt at_etx_${VALUE}_${RATE}
	mv *pcap at_etx_${VALUE}_${RATE}
	mv tun*txt at_etx_${VALUE}_${RATE}
	mv nohup.out at_etx_${VALUE}_${RATE}
	mv route.out at_etx_${VALUE}_${RATE}
	mv at_etx_${VALUE}_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE at_etx_${VALUE}_${RATE}/.
	mv udp.out at_etx_${VALUE}_${RATE}/.
	mv coordinator.out at_etx_${VALUE}_${RATE}/.
