...
#	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir ct_nbr_${VALUE}_${RATE}
	mv COOJA* log*txt ct_nbr_${VALUE}_${RATE}
	mv *pcap ct_nbr_${VALUE}_${RATE}
	mv tun*txt ct_nbr_${VALUE}_${RATE}
	mv nohup.out ct_nbr_${VALUE}_${RATE}
	mv route.out ct_nbr_${VALUE}_${RATE}
	mv ct_nbr_${VALUE}_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE ct_nbr_${VALUE}_${RATE}/.
	mv udp.out ct_nbr_${VALUE}_${RATE}/.
	mv coordinator.out ct_nbr_${VALUE}_${RATE}/.
