...
#	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.uc.rx /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir uc_rx_${VALUE}_${RATE}
	mv COOJA* log*txt uc_rx_${VALUE}_${RATE}
	mv *pcap uc_rx_${VALUE}_${RATE}
	mv tun*txt uc_rx_${VALUE}_${RATE}
	mv nohup.out uc_rx_${VALUE}_${RATE}
	mv route.out uc_rx_${VALUE}_${RATE}
	mv uc_rx_${VALUE}_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE uc_rx_${VALUE}_${RATE}/.
	mv udp.out uc_rx_${VALUE}_${RATE}/.
	mv coordinator.out uc_rx_${VALUE}_${RATE}/.
