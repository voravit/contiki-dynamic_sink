...
#	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir at_rank_${VALUE}_${RATE}
	mv COOJA* log*txt at_rank_${VALUE}_${RATE}
	mv *pcap at_rank_${VALUE}_${RATE}
	mv tun*txt at_rank_${VALUE}_${RATE}
	mv nohup.out at_rank_${VALUE}_${RATE}
	mv route.out at_rank_${VALUE}_${RATE}
	mv at_rank_${VALUE}_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE at_rank_${VALUE}_${RATE}/.
	mv udp.out at_rank_${VALUE}_${RATE}/.
	mv coordinator.out at_rank_${VALUE}_${RATE}/.
