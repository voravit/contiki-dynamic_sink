...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir s_4_${RATE}
	mv COOJA* log*txt s_4_${RATE}
	mv *pcap s_4_${RATE}
	mv tun*txt s_4_${RATE}
	mv nohup.out s_4_${RATE}
	mv route.out s_4_${RATE}
	mv s_4_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE s_4_${RATE}/.
	mv udp.out s_4_${RATE}/.
	mv coordinator.out s_4_${RATE}/.
