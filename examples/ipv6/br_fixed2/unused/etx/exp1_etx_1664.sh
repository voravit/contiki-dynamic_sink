...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.etx.1664 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	java -mx1664m -jar ${BASE_COOJA}/dist/cooja.jar -nogui=$FILE
	...
	sleep 2
	mkdir etx_1664_${RATE}
	mv COOJA* log*txt etx_1664_${RATE}
	mv *pcap etx_1664_${RATE}
	mv tun*txt etx_1664_${RATE}
	mv nohup.out etx_1664_${RATE}
	mv route.out etx_1664_${RATE}
	mv etx_1664_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE etx_1664_${RATE}/.
	mv udp.out etx_1664_${RATE}/.
	mv coordinator.out etx_1664_${RATE}/.
