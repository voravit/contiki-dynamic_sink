...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.etx.1024 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir etx_1024_${RATE}
	mv COOJA* log*txt etx_1024_${RATE}
	mv *pcap etx_1024_${RATE}
	mv tun*txt etx_1024_${RATE}
	mv nohup.out etx_1024_${RATE}
	mv route.out etx_1024_${RATE}
	mv etx_1024_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE etx_1024_${RATE}/.
	mv udp.out etx_1024_${RATE}/.
	mv coordinator.out etx_1024_${RATE}/.
