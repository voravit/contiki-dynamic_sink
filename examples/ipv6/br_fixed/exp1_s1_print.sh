...
CTR=0
	...
	cp grid_16_s${SINKS}.csc run.csc
...
#	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir s1_100_${RATE}
	mv COOJA* log*txt s1_100_${RATE}
	mv *pcap s1_100_${RATE}
	mv tun*txt s1_100_${RATE}
	mv nohup.out s1_100_${RATE}
	mv route.out s1_100_${RATE}
	mv s1_100_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE s1_100_${RATE}/.
	mv udp.out s1_100_${RATE}/.
	mv coordinator.out s1_100_${RATE}/.
