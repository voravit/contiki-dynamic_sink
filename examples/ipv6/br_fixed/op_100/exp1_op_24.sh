...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.op24 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir op_24_${RATE}
	mv COOJA* log*txt op_24_${RATE}
	mv *pcap op_24_${RATE}
	mv tun*txt op_24_${RATE}
	mv nohup.out op_24_${RATE}
	mv route.out op_24_${RATE}
	mv op_24_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE op_24_${RATE}/.
	mv udp.out op_24_${RATE}/.
	mv coordinator.out op_24_${RATE}/.
