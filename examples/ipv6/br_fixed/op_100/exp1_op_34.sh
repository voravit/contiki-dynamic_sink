...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.op34 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir op_34_${RATE}
	mv COOJA* log*txt op_34_${RATE}
	mv *pcap op_34_${RATE}
	mv tun*txt op_34_${RATE}
	mv nohup.out op_34_${RATE}
	mv route.out op_34_${RATE}
	mv op_34_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE op_34_${RATE}/.
	mv udp.out op_34_${RATE}/.
	mv coordinator.out op_34_${RATE}/.
