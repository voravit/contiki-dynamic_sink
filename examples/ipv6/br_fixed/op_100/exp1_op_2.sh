...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.op2 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir op_2_${RATE}
	mv COOJA* log*txt op_2_${RATE}
	mv *pcap op_2_${RATE}
	mv tun*txt op_2_${RATE}
	mv nohup.out op_2_${RATE}
	mv route.out op_2_${RATE}
	mv op_2_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE op_2_${RATE}/.
	mv udp.out op_2_${RATE}/.
	mv coordinator.out op_2_${RATE}/.
