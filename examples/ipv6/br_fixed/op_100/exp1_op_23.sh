...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.op23 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir op_23_${RATE}
	mv COOJA* log*txt op_23_${RATE}
	mv *pcap op_23_${RATE}
	mv tun*txt op_23_${RATE}
	mv nohup.out op_23_${RATE}
	mv route.out op_23_${RATE}
	mv op_23_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE op_23_${RATE}/.
	mv udp.out op_23_${RATE}/.
	mv coordinator.out op_23_${RATE}/.
