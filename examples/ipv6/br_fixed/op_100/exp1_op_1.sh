...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir op_1_${RATE}
	mv COOJA* log*txt op_1_${RATE}
	mv *pcap op_1_${RATE}
	mv tun*txt op_1_${RATE}
	mv nohup.out op_1_${RATE}
	mv route.out op_1_${RATE}
	mv op_1_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE op_1_${RATE}/.
	mv udp.out op_1_${RATE}/.
	mv coordinator.out op_1_${RATE}/.
