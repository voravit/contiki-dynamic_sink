...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.op3 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir op_3_${RATE}
	mv COOJA* log*txt op_3_${RATE}
	mv *pcap op_3_${RATE}
	mv tun*txt op_3_${RATE}
	mv nohup.out op_3_${RATE}
	mv route.out op_3_${RATE}
	mv op_3_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE op_3_${RATE}/.
	mv udp.out op_3_${RATE}/.
	mv coordinator.out op_3_${RATE}/.
