...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.op4 /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir op_4_${RATE}
	mv COOJA* log*txt op_4_${RATE}
	mv *pcap op_4_${RATE}
	mv tun*txt op_4_${RATE}
	mv nohup.out op_4_${RATE}
	mv route.out op_4_${RATE}
	mv op_4_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE op_4_${RATE}/.
	mv udp.out op_4_${RATE}/.
	mv coordinator.out op_4_${RATE}/.
