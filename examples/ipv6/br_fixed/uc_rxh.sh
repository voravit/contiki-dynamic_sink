...
#	cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir uc_rxh_${VALUE}_${RATE}
	mv COOJA* log*txt uc_rxh_${VALUE}_${RATE}
	mv *pcap uc_rxh_${VALUE}_${RATE}
	mv tun*txt uc_rxh_${VALUE}_${RATE}
	mv nohup.out uc_rxh_${VALUE}_${RATE}
	mv route.out uc_rxh_${VALUE}_${RATE}
	mv uc_rxh_${VALUE}_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE uc_rxh_${VALUE}_${RATE}/.
	mv udp.out uc_rxh_${VALUE}_${RATE}/.
	mv coordinator.out uc_rxh_${VALUE}_${RATE}/.
