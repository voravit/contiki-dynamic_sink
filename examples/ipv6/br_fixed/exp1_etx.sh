...
#        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.rank /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        cp -a /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c.etx /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
        sed -i "s/ETX 1024/ETX ${ETX}/" /home/voravit/repo/current/main/contiki/core/net/rpl/rpl-metric-timer.c
	...
	sleep 2
	mkdir etx_${ETX}_${RATE}
	mv COOJA* log*txt etx_${ETX}_${RATE}
	mv *pcap etx_${ETX}_${RATE}
	mv tun*txt etx_${ETX}_${RATE}
	mv nohup.out etx_${ETX}_${RATE}
	mv route.out etx_${ETX}_${RATE}
	mv etx_${ETX}_${RATE} ${BASE_TEST}/.
	cd $BASE_TEST
	mv $LOGFILE etx_${ETX}_${RATE}/.
	mv udp.out etx_${ETX}_${RATE}/.
	mv coordinator.out etx_${ETX}_${RATE}/.
